...
def printoutput(score):
    ...
    if class_names[max_index] == "Ajanta Caves":
        st.markdown('''
    ...
    elif class_names[max_index] == "Charar-E- Sharif":
            st.markdown('''
    ...
    elif class_names[max_index] == "Chhota_Imambara":
            st.markdown('''
                # Monument name : *`Chhota Imambara`*
                # Description : 
                '''
            )
    ...
    elif class_names[max_index] == "Ellora Caves":
        st.markdown('''
    ...
    elif class_names[max_index] == "Fatehpur Sikri":
        st.markdown('''
    ...
    elif class_names[max_index] == " Gateway of India":
        st.markdown('''
    ...
    elif class_names[max_index] == "Humayun's Tomb":
        st.markdown('''
    ...
    elif class_names[max_index] == "India gate pics":
        st.markdown('''
            # Monument name : **`India gate`**
            # Description : 
            '''
        )
        st.write(Description[7])
    ...
    elif class_names[max_index] == "Khajuraho":
        st.markdown('''
    ...
    elif class_names[max_index] == "Sun Temple Konark":
        st.markdown('''
    ...
    elif class_names[max_index] == "alai_darwaza":
        st.markdown('''
    ...
    elif class_names[max_index] == "alai_minar":
        st.markdown('''
            # Monument name : **`Alai Minar`**
            # Description : 
            '''
        )
        st.write(Description[11])
    ...
    elif class_names[max_index] == "basilica_of_bom_jesus":
        st.markdown('''
            # Monument name : *`Basilica of Bom Jesus`*
            # Description : 
            '''
        )
        st.write(Description[12])
    ...
    elif class_names[max_index] == "charminar":
            st.markdown('''
                # Monument name : *`Charminar`*
                # Description : 
                '''
            )
            st.write(Description[13])
    ...
    elif class_names[max_index] == "golden temple":
        st.markdown('''
            # Monument name : **`Golden Temple`**
            # Description : 
            '''
        )
        st.write(Description[14])
    ...
    elif class_names[max_index] == "hawa mahal pics":
        st.markdown('''
            # Monument name : **`Hawa Mahal `**
            # Description : 
            '''
        )
        st.write(Description[15])
    ...
    elif class_names[max_index] == "iron_pillar":
        st.markdown('''
            # Monument name : **`Iron Pillar`**
            # Description : 
            '''
        )
        st.write(Description[16])
    ...
    elif class_names[max_index] == "jamali_kamali_tomb":
        st.markdown('''
            # Monument name : **`Jamali Kamali tomb `**
            # Description : 
            '''
        )
        st.write(Description[17])
    ...
    elif class_names[max_index] == "lotus_temple":
        st.markdown('''
            # Monument name : **`Lotus Temple`**
            # Description : 
            '''
        )
        st.write(Description[18])
    ...
    elif class_names[max_index] == "mysore_palace":
        st.markdown('''
            # Monument name : **`Mysore palace`**
            # Description : 
            '''
        )
        st.write(Description[19])
    ...
    elif class_names[max_index] == "qutub_minar":
        st.markdown('''
            # Monument name : **`Qutub Minar `**
            # Description : 
            '''
        )
        st.write(Description[20])
    ...
    elif class_names[max_index] == "tajmahal":
        st.markdown('''
            # Monument name : **`Taj Mahal`**
            # Description : 
            '''
        )
        st.write(Description[21])
    ...
    elif class_names[max_index] == "tanjavur temple":
        st.markdown('''
            # Monument name : **`Tanjavur temple`**
            # Description : 
            '''
        )
        st.write(Description[22])
    ...
    elif class_names[max_index] == "Victoria Memorial":
        st.markdown('''
            # Monument name : **`Victoria Memorial`**
            # Description : 
            '''
        )
        st.write(Description[23])
...
Description = ['''`The Ajanta Caves are approximately 30 rock-cut Buddhist cave monuments dating from the 2nd century BCE to about 480 CE in the 
...
`''',
'''`Chota Imambara, also known as Imambara Hussainabad Mubarak is an imposing monument located in the city of Lucknow, Uttar Pradesh, India. It took 54 years to finalize it. Built as an imambara or a congregation hall for Shia Muslims, by Muhammad Ali Shah, the Nawab of Awadh in 1838,[1] it was to serve as a mausoleum for himself and his mother, who is buried beside him.The significance of Panjetan, the holy five, is once again emphasized here with five main doorways. This Imambara consist of two halls and a Shehnasheen (a platform where the Zarih of Imam Husain is kept.) Zarih is the replica of that protective grill or structure which is kept on the grave of Imam Husain at Karbala, Iraq. The large green and white bordered hall of Azakhana is richly decorated with chandeliers and a good number of crystal glass lamp-stands. In fact, it was for this profuse decoration that the Imambara was referred by European visitors and writers as The Palace of Lights. The exterior is very beautifully decorated with Quranic verses in Islamic calligraphy .It is situated near the Bara Imambara and on the connecting road stands an imposing gateway known as Rumi Darwaza.The building is also known as the Palace of Lights because of its decorations and chandeliers during special festivals, like Muharram.
...
'''Humayun’s Tomb, Delhi is the first of the grand dynastic mausoleums that were 
        ...
        '''`The Khajuraho Group of Monuments are a group of Hindu and Jain temples in Chhatarpur district,
...
'''`Konark Sun Temple is a 13th-century CE (year 1250)
         Sun temple at Konark about 35 kilometres (22 mi) northeast from Puri city on the coastline in Puri district, Odisha,
          ...
          '''`Ala'i Darwaza (Urdu: علاء دروازه, lit. 'Gate of Alauddin') is the southern gateway of the Quwwat-ul-Islam Mosque in Qutb complex, Mehrauli,
...
`''',
'''`The Alai Minar is an incomplete monument that lies within the Qutb complex in South Delhi. Sultan Ala-ud-Din Khalji was an over ambitious Sultan of the Khilji dynasty and won many wars and battles.
...
`''',
'''`The Golden Temple (also known as the Harmandir Sahib, lit. 'abode of God', It is a gurdwara located in the city of Amritsar, Punjab, India. It is the preeminent spiritual site of Sikhism.
...
'''`The Lotus Temple, located in Delhi, India, is a Baháʼí House of Worship 
...
`''',
'''`The Mysore Palace, also known as Amba Vilas Palace, is a historical palace and a royal residence. 
